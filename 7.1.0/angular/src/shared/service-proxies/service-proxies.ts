...
export class EmployeeServiceProxy {
     ...
     * @return Success
     */
    getRoleForEdit(id: number | undefined): Observable<Employee> {
        let url_ = this.baseUrl + "/api/services/app/Employee/GetRoleForEdit?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
    ...
    protected processGetRoleForEdit(response: HttpResponseBase): Observable<Employee> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        return _observableOf<Employee>(null as any);
    }


    getEmployeeForEdit(id: number | undefined): Observable<Employee> {
        let url_ = this.baseUrl + "/api/services/app/Employee/GetEmployeeForEdit?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
    ...
    protected processGetEmployeeForEdit(response: HttpResponseBase): Observable<Employee> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    protected processGetAll(response: HttpResponseBase): Observable<EmployeeDtoPagedResultDto> {
        ...
        return _observableOf<EmployeeDtoPagedResultDto>(null as any);
    }
}
