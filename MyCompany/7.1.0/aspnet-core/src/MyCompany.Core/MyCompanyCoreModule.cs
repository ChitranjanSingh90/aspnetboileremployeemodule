...
namespace MyCompany
{
    ...
    public class MyCompanyCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            Configuration.Settings.SettingEncryptionConfiguration.DefaultPassPhrase = MyCompanyConsts.DefaultPassPhrase;
            SimpleStringCipher.DefaultPassPhrase = MyCompanyConsts.DefaultPassPhrase;
        }
